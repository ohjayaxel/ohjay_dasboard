...
import type { MarketsDataPoint } from "@/lib/data/agg"

type MetricOption = {
  key: keyof MarketsDataPoint
  label: string
}

type MarketsChartProps = {
  data: MarketsDataPoint[]
  currencyCode: string
  numberLocale: string
}
...
export function MarketsChart({
  ...
  const [selectedMetric, setSelectedMetric] = React.useState<keyof MarketsDataPoint>("net_sales")
          ...
          <div className="flex items-center justify-between">
            ...
            {isOpen && (
              <Select
                ...
                onValueChange={(value) => setSelectedMetric(value as keyof MarketsDataPoint)}
              >
